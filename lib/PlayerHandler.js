...
export default class PlayerHandler {
	 ...
	 * @returns {Promise<import('discord.js').Message>|false} The message that was sent.
	 */
	async locale(stringPath, { args = [], type = 'neutral', components = null, files = null } = {}) {
		return this.send(await getGuildLocaleString(this.player.guildId, stringPath, ...args), { type, components, files });
	}
}
