...
export default class ReplyHandler {
	 ...
	 * @param {{type?: "success"|"neutral"|"warning"|"error", components?: import('discord.js').ActionRowBuilder[], files?: import('discord.js').Attachment[], ephemeral?: boolean, force?: "reply"|"edit"|"update"}} optionals Extra data, such as type or components.
	 * @returns {Promise<import('discord.js').Message|boolean>} The message that was sent.
	 */
	async reply(msgData, { type = 'neutral', components = null, files = null, ephemeral = false, force = null } = {}) {
	 ...
	 * @param {{type?: "success"|"neutral"|"warning"|"error", args?: string[], components?: import('discord.js').ActionRowBuilder[], files?: import('discord.js').Attachment[], ephemeral?: boolean, force?: "reply"|"edit"|"update"}} optionals Extra data, such as type or components.
	 * @returns {Promise<import('discord.js').Message|boolean>} The message that was sent.
	 */
