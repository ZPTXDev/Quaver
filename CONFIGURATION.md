...
| `features.autolyrics.premium`   | Whether to display the "requires premium" message when a guild is not whitelisted. Has no effect if `features.autolyrics.whitelist` is `false` or `premiumURL` is unset.                                                                                                                                                                                          | ✅ (if feature is enabled)<br />❌ (if feature is disabled) | `6.7.0`       |
...
| `features.stay.premium`         | Whether to display the "requires premium" message when a guild is not whitelisted. Has no effect if `features.stay.whitelist` is `false` or `premiumURL` is unset.                                                                                                                                                                                                | ✅ (if feature is enabled)<br />❌ (if feature is disabled) | `6.7.0`       |
...
| `features.smartqueue.premium`   | Whether to display the "requires premium" message when a guild is not whitelisted. Has no effect if `features.smartqueue.whitelist` is `false` or `premiumURL` is unset.                                                                                                                                                                                          | ✅ (if feature is enabled)<br />❌ (if feature is disabled) | `6.8.0`       |
