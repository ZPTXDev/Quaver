...
| `features.autoplay`                                   | Autoplay feature: Automatically queues similar tracks when the queue ends to keep music playing continuously.                                                                                                                                                                                                                                                     | ✅                                                         | `8.0.0`       |
| `features.autoplay.enabled`                           | Whether the feature is enabled.                                                                                                                                                                                                                                                                                                                                   | ✅                                                         | `8.0.0`       |
| `features.autoplay.whitelist`                         | Whether the feature requires guilds to be whitelisted. You will be able to whitelist guilds through the terminal.                                                                                                                                                                                                                                                 | ✅ (if feature is enabled)<br />❌ (if feature is disabled) | `8.0.0`       |
| `features.autoplay.premium`                           | Whether to display the "requires premium" message when a guild is not whitelisted. Has no effect if `features.autoplay.whitelist` is `false` or `premiumEnabled` is `false`.                                                                                                                                                                                      | ✅ (if feature is enabled)<br />❌ (if feature is disabled) | `8.0.0`       |
| `features.autoplay.provider`                          | The recommendation provider to use for autoplay. Valid values are `listenbrainz` (default) or `lastfm`. ListenBrainz uses collaborative filtering based on listening patterns, while Last.fm provides artist/track similarity recommendations.                                                                                                                    | ❌ (defaults to `listenbrainz`)                            | `8.0.0`       |
| `features.autoplay.listenbrainzToken`                 | Your ListenBrainz user token. Required if using `listenbrainz` as the provider. You can get your token from [ListenBrainz Settings](https://listenbrainz.org/settings/). Used to access the recommendation API.                                                                                                                                                   | ❌ (required for ListenBrainz provider)                    | `8.0.0`       |
| `features.autoplay.lastfmApiKey`                      | Your Last.fm API key. Required if using `lastfm` as the provider. You can get an API key from the [Last.fm API page](https://www.last.fm/api/account/create). Used to access the similar tracks API.                                                                                                                                                             | ❌ (required for Last.fm provider)                         | `8.0.0`       |
