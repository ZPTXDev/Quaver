export default {
    '247': {
        DESCRIPTION: 'Ang 24/7 nga mode kay nagpugong sa pagbiya ni Quaver.',
    ...
    INFO: {
        ...
        RESPONSE: {
            ...
            MENTION: 'Hi! Si Quaver kay naggamit og [Mga slash command](https://support-apps.discord.com/hc/en-us/articles/26501837786775-Slash-Commands-FAQ).\nAlang sa dugang mga impormasyon bahin ni Quaver, gamita ang </info:%1>.\nAron makatukar og track, sulayi ang </play:%2> o </search:%3>.\nAron ma-configure si Quaver, gamita ang </settings:%4>.'
        },
        MISC: {
    ...
    PLAY: {
        ...
        RESPONSE: {
            NO_RESULTS: 'Walay nakit-an nga mga resulta gikan sa imong query.',
